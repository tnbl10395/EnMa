    ...
    <div class="left">
        <table>
            <tr>
                <th> <div class="amount">
                        <a href="">
                            <img src=<?php echo e(asset("img/person.png")); ?>  style="width:40px;height:40px;">
                        </a>
                        <div class="esum">
                            <span>2,294</span>
                        </div>
                ...
                <th>  <div class="amount">
                        <a href="">
                            <img src=<?php echo e(asset("img/team.jpg")); ?>  style="width:40px;height:40px;">
                        </a>
                        <div class="esum">
                            <span>2,294</span>
                        </div>
                ...
                <th><div class="amount">
                        <a href="">
                            <img src=<?php echo e(asset("img/project.png")); ?>  style="width:40px;height:40px;">
                        </a>
                        <div class="esum">
                            <span>2,294</span>
                        </div>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <div class="right">
        <div class="acount">
            <a href="#">
                <img src=<?php echo e(asset("img/account.jpg")); ?> style="width:70px;height:70px;">
            </a>
        </div>
    </div>
</div>
