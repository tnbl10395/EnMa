...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
        ...
        <li class="submenu"><a href="#"><i class="icon icon-th-list"></i> <span>Manage Team</span> <span
        ...
        <li class="submenu"><a href="#"><i class="icon icon-file"></i> <span>Manage Project</span> <span
                        class="label label-important">2</span></a>
            <ul>
        ...
        <li class="submenu"><a href="#"><i class="icon icon-info-sign"></i> <span>Manage Engineer</span> <span
                        class="label label-important">2</span></a>
            <ul>
